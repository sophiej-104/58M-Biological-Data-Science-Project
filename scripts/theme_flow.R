theme_flow <- function (base_size = 11, base_family = "", base_line_size = base_size/22, 
                                  base_rect_size = base_size/22) 
{
  ...
  t <- theme(line = element_line(colour = "black", size = base_line_size, 
             ...
             axis.line.y = NULL, axis.text = element_text(size = rel(0.8), 
                                                          colour = "dark blue"), axis.text.x = element_text(margin = margin(t = 0.8 * 
             ...
             panel.ontop = FALSE, strip.background = element_rect(fill = "#A7DEF4", 
