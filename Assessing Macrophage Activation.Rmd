...
```{r setting the initial gating regions for log data, fig.show="hold", out.width="50%"}
...
```{r setting the initial gating regions for logicle data, fig.show="hold", out.width="50%"}
