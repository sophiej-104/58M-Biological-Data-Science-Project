...
The TNF-$\alpha$ production from RAW 264.7 cells is shown in \@ref(western-blot-figure) and \@ref(Rf-figure). Membranes from the SDS-PAGE were incubated with the primary antibody solution, rabbit anti-TNF-$\alpha$ in TBS-T with 5% milk, and consequently incubated with the secondary antibody solution, goat anti-rabbit IgG-linked to horseradish peroxidase in PBS-T in milk. 
...
\@ref(western-blot-figure) indicates that only RAW 264.7 cells treated with 100 ng/ml LPS from *E.coli* and RAW 264.7 cells treated with *E.coli* bacteria produced TNF-$\alpha$, as shown by the bands labelled B1, B2, C1 and C2 respectively. 

\@ref(Rf-figure), illustrates the calculation of the molecular weights of the labelled bands from \@ref(western-blot-figure), using the calculated molecular weights of the molecular marker bands. From the calculated molecular weights of \@ref(Rf-figure), the identity of the bands on the Western Blot can be confirmed to be that of TNF-$\alpha$. Bands B1 and C1 calculated to be 28.3 kDa and 27.11 kDa respectively. Bands B2 and C2 calculated to be 22.9 kDa and 23.89 kDa respectively. These were compared to the datasheet, [@CellSignal2017-rp] and [@UniProtConsortium2019-su], to confirm the identification of the TNF-$\alpha$ bands. 
...
<!-- figure legend -->
(ref:Rf-value) **Identification of the Molecular Weight of TNF-$\alpha$ using Rf values** <BR> **Dashed Red** - B1 band shown in \@ref(western-blot-figure), **Red** - B2 band shown in \@ref(western-blot-figure), **Dashed Blue** - C1 band shown in \@ref(western-blot-figure), **Blue** - C2 band shown in \@ref(western-blot-figure).
<!-- end of figure legend -->
