...
ggcyto(fcm1A_comp_trans, aes(x = "FS.Area", y = "SS.Area")) + geom_hex(bins = 100) + theme_bw()

ggcyto(fcm1B_comp_trans, aes(x = "FS.Area", y = "SS.Area")) + geom_hex(bins = 100) + theme_bw()

ggcyto(fcm2A_comp_trans, aes(x = "FS.Area", y = "SS.Area")) + geom_hex(bins = 100) + theme_bw()

ggcyto(fcm2B_comp_trans, aes(x = "FS.Area", y = "SS.Area")) + geom_hex(bins = 100) + theme_bw()
