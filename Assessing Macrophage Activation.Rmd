...
fcm1A_summary <- as.data.frame(fcm1A_summary[3, 12]) %>% mutate(., Mean = mean_fcm1A) %>%
  mutate(., Cell_Count = cell_count_1A) %>% rename(Median = `fcm1A_summary[3, 12]`) %>% mutate(., LPS_Stimulation = "-") %>% mutate(., Anti_TNF_Stain = "-")
...
fcm1B_summary <- as.data.frame(fcm1B_summary[3, 12]) %>% mutate(., Mean = mean_fcm1B) %>%
  mutate(., Cell_Count = cell_count_1B) %>% rename(Median = `fcm1B_summary[3, 12]`) %>% mutate(., LPS_Stimulation = "-") %>% mutate(., Anti_TNF_Stain = "+")
...
fcm2A_summary <- as.data.frame(fcm2A_summary[3, 12]) %>% mutate(., Mean = mean_fcm2A) %>%
  mutate(., Cell_Count = cell_count_2A) %>% rename(Median = `fcm2A_summary[3, 12]`) %>% mutate(., LPS_Stimulation = "+") %>% mutate(., Anti_TNF_Stain = "-")
...
fcm2B_summary <- as.data.frame(fcm2B_summary[3, 12]) %>% mutate(., Mean = mean_fcm2B) %>%
  mutate(., Cell_Count = cell_count_2B) %>% rename(Median = `fcm2B_summary[3, 12]`) %>% mutate(., LPS_Stimulation = "+") %>% mutate(., Anti_TNF_Stain = "+")

log_summary <- rbind(fcm1A_summary, fcm1B_summary, fcm2A_summary, fcm2B_summary)
log_summary <- log_summary[, c(4, 5, 3, 2, 1)]
