...
```{r plot log channel data, include=FALSE}
...
# find a way of plotting all four together

```

### Logicle FS vs SS Plots

```{r plot logicle transformed data, include=FALSE}
...
# find a way to plot all four together

```

## Gating the Samples 

```{r setting the initial gating regions for log data}
...
ggcyto(fcm1A_comp_trans, aes(x = "FS.Log", y = "SS.Log")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r1) + geom_stats()

fcm1A_gate_r1 <- Subset(fcm1A_comp_trans, gate_r1)
fcm1A_gate_r1df <- data.frame(fcm1A_gate_r1@exprs)

ggcyto(fcm1B_comp_trans, aes(x = "FS.Log", y = "SS.Log")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r1) + geom_stats()

fcm1B_gate_r1 <- Subset(fcm1B_comp_trans, gate_r1)
fcm1B_gate_r1df <- data.frame(fcm1B_gate_r1@exprs)

ggcyto(fcm2A_comp_trans, aes(x = "FS.Log", y = "SS.Log")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r1) + geom_stats()

fcm2A_gate_r1 <- Subset(fcm2A_comp_trans, gate_r1)
fcm2A_gate_r1df <- data.frame(fcm2A_gate_r1@exprs)

ggcyto(fcm2B_comp_trans, aes(x = "FS.Log", y = "SS.Log")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r1) + geom_stats()
...
```{r setting the initial gating regions for logicle data}
...
ggcyto(fcm1A_comp_trans, aes(x = "FS.Lin", y = "SS.Lin")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r2) + geom_stats()

fcm1A_gate_r2 <- Subset(fcm1A_comp_trans, gate_r2)
fcm1A_gate_r2df <- data.frame(fcm1A_gate_r2@exprs)

ggcyto(fcm1B_comp_trans, aes(x = "FS.Lin", y = "SS.Lin")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r2) + geom_stats()

fcm1B_gate_r2 <- Subset(fcm1B_comp_trans, gate_r2)
fcm1B_gate_r2df <- data.frame(fcm1B_gate_r2@exprs)

ggcyto(fcm2A_comp_trans, aes(x = "FS.Lin", y = "SS.Lin")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r2) + geom_stats()

fcm2A_gate_r2 <- Subset(fcm2A_comp_trans, gate_r2)
fcm2A_gate_r2df <- data.frame(fcm2A_gate_r2@exprs)

ggcyto(fcm2B_comp_trans, aes(x = "FS.Lin", y = "SS.Lin")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r2) + geom_stats()
...
<!-- Need to create a table of summary information for the cell counts etc. for the gated samples -->
