...
ggcyto(fcm1A_comp_trans, aes(x = "FS.Log", y = "SS.Log")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r1)

fcm1A_gate_r1 <- Subset(fcm1A_comp_trans, gate_r1)
fcm1A_gate_r1df <- data.frame(fcm1A_gate_r1@exprs)

ggcyto(fcm1B_comp_trans, aes(x = "FS.Log", y = "SS.Log")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r1)

fcm1B_gate_r1 <- Subset(fcm1B_comp_trans, gate_r1)
fcm1B_gate_r1df <- data.frame(fcm1B_gate_r1@exprs)

ggcyto(fcm2A_comp_trans, aes(x = "FS.Log", y = "SS.Log")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r1)

fcm2A_gate_r1 <- Subset(fcm2A_comp_trans, gate_r1)
fcm2A_gate_r1df <- data.frame(fcm2A_gate_r1@exprs)

ggcyto(fcm2B_comp_trans, aes(x = "FS.Log", y = "SS.Log")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r1)
...
ggcyto(fcm1A_comp_trans, aes(x = "FS.Lin", y = "SS.Lin")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r2)

fcm1A_gate_r2 <- Subset(fcm1A_comp_trans, gate_r2)
fcm1A_gate_r2df <- data.frame(fcm1A_gate_r2@exprs)

ggcyto(fcm1B_comp_trans, aes(x = "FS.Lin", y = "SS.Lin")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r2)

fcm1B_gate_r2 <- Subset(fcm1B_comp_trans, gate_r2)
fcm1B_gate_r2df <- data.frame(fcm1B_gate_r2@exprs)

ggcyto(fcm2A_comp_trans, aes(x = "FS.Lin", y = "SS.Lin")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r2)

fcm2A_gate_r2 <- Subset(fcm2A_comp_trans, gate_r2)
fcm2A_gate_r2df <- data.frame(fcm2A_gate_r2@exprs)

ggcyto(fcm2B_comp_trans, aes(x = "FS.Lin", y = "SS.Lin")) + geom_hex(bins = 100) + theme_bw() + geom_gate(gate_r2)
